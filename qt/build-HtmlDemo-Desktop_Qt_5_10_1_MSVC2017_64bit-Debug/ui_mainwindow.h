...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setStyleSheet(QLatin1String("background-image: url(:/resources/img/bg-image.jpg);\n"
